...
class ReasoningBrowserEndToEndTests(unittest.TestCase):
    ...
    def test_reasoning_controls_and_sidebar_details_are_responsive(self):
        ...
        details = self.page.locator("#contextDetails")
        ...
        self.page.get_by_role("button", name="Preferences", exact=True).click()
        expect(self.page.get_by_role("dialog", name="Preferences", exact=True)).to_be_visible()
