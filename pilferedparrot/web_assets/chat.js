...
async function applyBrowserTheme(theme, refreshGeneration = null) {
  ...
  document.body.classList.toggle("chrome-theme-frame-art", selected.active && frameArtwork);
  document.body.classList.toggle("chrome-theme-toolbar-art", selected.active && toolbarArtwork);
