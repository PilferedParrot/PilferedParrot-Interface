...
- Keep Work provider-native and make any harness change evidence-led. Follow the
  [Harness review](docs/harness-review.md) and [design language](docs/design-language.md): do not
  add hidden routing, automatic retries, second-model review, recursive schedulers, or repeated
