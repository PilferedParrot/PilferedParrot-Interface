...
The current checkout is the **0.7.0-rc.9 preview**. Linux 0.6.1 remains the stable release;
the Windows 10/11 x64 build is a portable preview. Preview downloads are available from the
[0.7.0-rc.9 release](https://github.com/PilferedParrot/PilferedParrot-Interface/releases/tag/v0.7.0-rc.9).

[Project site](https://pilferedparrot.github.io/PilferedParrot-Interface/) ·
[Linux rc.9 source archive](https://github.com/PilferedParrot/PilferedParrot-Interface/releases/download/v0.7.0-rc.9/pilferedparrot-0.7.0-rc.9-source.tar.gz) ·
[Stable Linux release](https://github.com/PilferedParrot/PilferedParrot-Interface/releases/tag/v0.6.1) ·
[Release notes](RELEASE_NOTES.md) ·
[Windows preview ZIP](https://github.com/PilferedParrot/PilferedParrot-Interface/releases/download/v0.7.0-rc.9/PilferedParrot-0.7.0-rc.9-windows-x64.zip) ·
...
*The image uses a synthetic conversation; it contains no real account or chat data.*
...
Download the [rc.9 source archive](https://github.com/PilferedParrot/PilferedParrot-Interface/releases/download/v0.7.0-rc.9/pilferedparrot-0.7.0-rc.9-source.tar.gz),
...
Download the [0.7.0-rc.9 Windows x64 ZIP](https://github.com/PilferedParrot/PilferedParrot-Interface/releases/download/v0.7.0-rc.9/PilferedParrot-0.7.0-rc.9-windows-x64.zip),
